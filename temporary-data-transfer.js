  ...
  function makeUi(options) {
    ...
    dialog.innerHTML = `
      <section class="ryan-transfer-card" aria-labelledby="ryan-transfer-title">
        ...
        <p>Move this app’s saved settings and data between browsers with a portable transfer file. Photos and videos are not included.</p>
    ...
    style.textContent = `
      ...
      .ryan-transfer-open:focus-visible,.ryan-transfer-dialog button:focus-visible{outline:3px solid #1677ff!important;outline-offset:2px!important}
      ...
      .ryan-transfer-dialog::backdrop{background:rgba(0,0,0,.62)!important}
      .ryan-transfer-card{padding:18px!important}
      .ryan-transfer-card header{display:flex!important;justify-content:space-between!important;gap:16px!important;align-items:flex-start!important;padding-bottom:12px!important;border-bottom:2px solid #a8be9a!important}
      .ryan-transfer-card h2,.ryan-transfer-card h3,.ryan-transfer-card p{margin:0!important;color:#102117!important;text-align:left!important}
      .ryan-transfer-card h2{font-size:24px!important}
      .ryan-transfer-card h3{font-size:17px!important}
      .ryan-transfer-card small{font-weight:700!important;letter-spacing:.09em!important}
      .ryan-transfer-card header button{min-width:36px!important;min-height:36px!important;font-size:24px!important}
      .ryan-transfer-actions{display:flex!important;flex-wrap:wrap!important;gap:9px!important;margin:15px 0!important}
      ...
      .ryan-transfer-card button:disabled{opacity:.56!important;cursor:not-allowed!important}
      .ryan-transfer-status,.ryan-transfer-preview{margin-top:13px!important;padding:12px!important;border:1px solid #8ba377!important;border-radius:7px!important;background:#fff!important}
      .ryan-transfer-preview h3{margin-bottom:5px!important}
      .ryan-transfer-preview button{margin-top:10px!important}
      .ryan-transfer-footnote{margin-top:14px!important;font-size:12px!important;color:#34503c!important}
      @media(max-width:520px){.ryan-transfer-card{padding:14px!important}.ryan-transfer-open{right:8px!important;bottom:8px!important}}`;
