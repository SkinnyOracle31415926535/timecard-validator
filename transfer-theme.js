...
(() => {
  ...
  function applyTheme() {
    ...
    style.textContent = `
      ...
      .ryan-transfer-actions,.ryan-v3-recovery-actions{display:flex!important;flex-wrap:wrap!important;gap:10px!important;margin-top:12px!important}
      ...
      @media(max-width:520px){.ryan-transfer-open{right:8px!important;bottom:8px!important}.ryan-v3-recovery-open{left:8px!important;bottom:54px!important}}
    `;
